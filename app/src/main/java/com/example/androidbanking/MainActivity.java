...
import com.example.androidbanking.Customer.CustomerMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Intent intent = new Intent(MainActivity.this, CloseAcct.class);
/*
                        temp.moveToNext();
...
/*
                    if (Test.getuserType().equals("Customer")) // Hard Coded for now, will have constants later
                    {
                        //intent.putExtra("USER", USER); //Bundle
                        intent = new Intent(MainActivity.this, TellerMain.class);
                    ...
                    else if(Test.getuserType().equals("Teller"))
                    {
                        intent = new Intent(MainActivity.this, TellerMain.class);
                        startActivity(intent);
                        finish();
